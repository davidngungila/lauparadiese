...
class TestSMS extends Command
{
    ...
    public function handle(NotificationService $notificationService)
    {
        ...
        $message = $this->option('message') ?? $this->ask('Enter message', 'Test message from Tour Booking System');
        ...
        if ($result) {
            ...
            $this->line("1. HTTP 403 - Not Authorized: Check SMS credentials");
            $this->line("2. Invalid phone format: Use 255XXXXXXXXX format");
            $this->line("3. Network issues: Check internet connection");
